...
export { ContactDivision } from './compass-models/contact/contact-division';
...
export { ContactOffice } from './compass-models/contact/contact-office';
export { ContactPracticeArea } from './compass-models/contact/contact-practice-area';
export { ContactStudio } from './compass-models/contact/contact-studio';
export { ContactTerritory } from './compass-models/contact/contact-territory';
